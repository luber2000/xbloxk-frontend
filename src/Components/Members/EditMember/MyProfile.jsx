        ...
        <CardBody>
          <Form>
              ...
              <div className='profile-title'>
                <div className='media'>
                  ...
                  <div className='media-body'>
                    <Link to={`${process.env.REACT_APP_PUBLIC_URL}/app/users/userProfile/`}>
            ...
            <FormGroup className='mb-3'>
              ...
              <Input className='form-control' placeholder='your-email@domain.com' defaultValue={userData?.email} />
            </FormGroup>
            <FormGroup className='mb-3'>

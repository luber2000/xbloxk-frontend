...
export const routes = [
  ...
  { path: `${process.env.PUBLIC_URL}/`, Component: <SamplePage /> },

  // // Team members
  { path: `${process.env.PUBLIC_URL}/members/`, Component: <ListMembers /> },
  { path: `${process.env.PUBLIC_URL}/member/add/`, Component: <AddTeamMember /> },
  { path: `${process.env.PUBLIC_URL}/member/edit/:userId`, Component: <EditMember /> },
  { path: `${process.env.PUBLIC_URL}/members-groups/`, Component: <TeamGroupPage /> },
  { path: `${process.env.PUBLIC_URL}/search-members/`, Component: <SearchMemberPage /> },
